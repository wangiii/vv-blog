    ...
    <div class="container">
        <div>
            ...
            <div class="list-group" style="margin-top: 5px">
                <div class="list-group-item list-group-item-action" v-for="category in categories">
                    <div @click="goCategory(category.id)" style="color: darkgray;">
                        {{ category.name }}
                        <div v-if="category.id === 3" style="display:inline;">
    ...
    export default {
        ...
        methods : {
            ...
            goCategory : function (id) {
                this.$router.push({ name : 'category', params : { id : id }}).catch(err => {})
            }
        }
    }
</script>
